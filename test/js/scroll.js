$(document).ready(function(){
    ...
    function scroll_chk(){
        ...
        if((sec02_obj_top - scrolling - window_h) < -offset){
            ...
            if(581 - (sec02_obj_top - scrolling - window_h + offset)*1.2 <= $(window).width()){
                $('.sec02 .photo').width(581 - (sec02_obj_top - scrolling - window_h + offset)*1.2)
            }
        }else{
