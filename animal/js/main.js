$(document).ready(function(){
    ...
    /* .visual .ctrl_btn .stop 정지 버튼을 클릭하면 팝업은 정지됨. stop 사라짐, play버튼 나타남
       .visual .ctrl_btn .play 재생 버튼을 클릭하면 팝업은 재생됨. play 사라짐, stop버튼 나타남 */
    ...
    /* .lost .list > ul > li 클릭했을때 li에 active 클래스 추가
    ...
    /* 입양 팝업 */
    const adopt_swiper = new Swiper('.adopt .swiper', { /* 팝업을 감싸는 요소의 class명 */
